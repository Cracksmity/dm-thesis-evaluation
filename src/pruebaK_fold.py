...
Ejecuta las fases 1 a 4 del proyecto: preprocesamiento, búsqueda de
hiperparámetros con validación cruzada, reducción por correlación y
comparación con el dataset reducido. Requiere ``data/DataSet_completo.xlsx``.
"""
